...
<section>
    <script type="text/javascript">
        SimpleJekyllSearch({
            ...
            searchResultTemplate: '<div class="search-title"><a href="{url}"><h1> {title}</h1></a><p class="meta">{date} <div class="right"><i class="fas fa-tag"></i> {tags}</p></div><p>{excerpt}</p></div><hr>',
