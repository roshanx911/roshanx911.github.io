...
<section>
    <script type="text/javascript">
        SimpleJekyllSearch({
            ...
            searchResultTemplate: '<div class="search-title"><a href="{url}"><h3> {title}</h3></a><p class="meta">{date} <div class="right"><i class="fas fa-tag"></i> {tags}</div></p><p>{content}</p></div><hr>',          
