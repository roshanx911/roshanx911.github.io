...
<section>
    <script type="text/javascript">
        SimpleJekyllSearch({
            ...
            searchResultTemplate: '<div class="search-title"><a href="{url}"><h3>{title}</h3></a><p class="meta">{date}</p><p w3-include-html="_includes/read-time.html"></p><p>{excerpt}</p><p><a href="{url}" class="read-more">More…</a></p></div><hr>',      
