...
<section>
    <script type="text/javascript">
        SimpleJekyllSearch({
            ...
            searchResultTemplate: '<div class="search-title"><a href="{url}"><h3>{title}</h3></a><p class="meta">{date}</p><p>{excerpt}</p>{% if post.excerpt contains '<!--more-->' %}<p><a href="{url}" class="read-more">More…</a></p>{% endif %}</div><hr>',
